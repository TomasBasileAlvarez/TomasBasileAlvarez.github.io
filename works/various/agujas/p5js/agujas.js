...
function setup() {
 ...
 text("N = Número total de agujas:",280,520);
 text(tot,480,520);

 text("n = Agujas que cortan una línea",280,540);
 text(buenos,480,540);
...
function Lineas(posx,posy,angu){
  ...
  this.display = function() {
    ...
    text("Aproximación de Pi (2*N/n): ",280,560);
    aproxi = Math.round(2*tot/buenos,5);
